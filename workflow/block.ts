...
export class WorkflowBlock {
    ...
    constructor(id: string, name: string, expressions: WorkflowExpression[], forks: WorkflowFork[] = [], parentBlocks: string[], parameters: WorkflowExpressionParameter[], results: WorkflowExpressionResult[], createdAt: Date, updatedAt: Date, deletedAt: Date) {
        this.id = id;
        this.name = name;
